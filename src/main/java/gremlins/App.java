...
public class App extends PApplet {
    ...
    public void direction() {
        if (wizard.direction == Vector2.UP)
            wizard.draw(this, this.up);
        else if (wizard.direction == Vector2.DOWN)
            wizard.draw(this, this.down);
        else if (wizard.direction == Vector2.LEFT)
            wizard.draw(this, this.left);
        else if (wizard.direction == Vector2.RIGHT)// Vector2.RIGHT:
